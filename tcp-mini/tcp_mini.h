...
//       .. TM_MAXMATCHES)
TM_FUNCTION int tm_become_a_match(int port);
// NOTE: returns 1 if succeeded
//       returns -1 if no code was executed (i.e. there was no match at port)
TM_FUNCTION int tm_stop_being_a_match(int port);

// NOTE: returns 1 if succeeded
//       returns -1 if no code was executed (i.e. there was no match at port..
//       .. or there was no scout w. ipAddressOrHostname for match at port)
TM_FUNCTION int tm_disconnect_scout(int port, char* ipAddressOrHostname);
...
TM_FUNCTION void tm_set_on_scout_connected(void(*a)(int, char*));
TM_FUNCTION void tm_unset_on_scout_connected();

// void(*on_scout_hung_up)(int port, char* ipAddressOrHostname);
TM_FUNCTION void tm_set_on_scout_hung_up(void(*a)(int, char*));
TM_FUNCTION void tm_unset_on_scout_hung_up();
#endif
...
//       .. TM_MAXSCOUTS)
TM_FUNCTION int tm_connect_to_match(struct tm_match_blob_t a);
// NOTE: returns 1 if succeeded
//       returns -1 if no code was executed (i.e. was not connected to match)
TM_FUNCTION int tm_disconnect_from_match(struct tm_match_blob_t a);

//void(*on_match_hung_up)(struct tm_match_blob_t a);
TM_FUNCTION void tm_set_on_match_hung_up(void(*a)(struct tm_match_blob_t));
TM_FUNCTION void tm_unset_on_match_hung_up();
#endif
...
TM_FUNCTION int tm_send_to_scout(int port, char* ipAddressOrHostname, struct tm_message_t* a, int b, void* c, int d);
...
//       returns 0 if something went wrong (i.e. message is invalid)
//       return -1 if no code was executed
TM_FUNCTION int tm_send_to_scouts(int port, struct tm_message_t* a, int b, void* c, int d);
...
TM_FUNCTION void tm_set_on_receive_from_scout(void(*a)(int, char*, struct tm_message_t*, int));
TM_FUNCTION void tm_unset_on_receive_from_scout();
...
TM_FUNCTION int tm_poll_from_scout(int port, char* ipAddress, int maxMessages);
// NOTE: if a scout disconnected.. will call on_scout_hung_up
// NOTE: don't call poll asynchronously (it is not officially supported)
// NOTE: set maxMessages to -1 to remove the limit (i.e. no # messages is "too much")
// will call on_receive_from_scout for each "polled" message
// will return 0 if no more messages left to process or 1 if there are
// will return -1 if no code was executed
TM_FUNCTION int tm_poll_from_scouts(int port, int maxMessages);
#endif
...
//       returns 0 if something went wrong (i.e. message is invalid)
//       return -1 if no code was executed
TM_FUNCTION int tm_send_to_match(struct tm_match_blob_t a, struct tm_message_t* b, int c, void* d, int e);
...
TM_FUNCTION void tm_set_on_receive_from_match(void(*a)(struct tm_match_blob_t, struct tm_message_t*, int));
TM_FUNCTION void tm_unset_on_receive_from_match();
...
// will return 0 if no more messages left to process or 1 if there are
// will return -1 if no code was executed
TM_FUNCTION int tm_poll_from_match(struct tm_match_blob_t a, int maxMessages);
#endif
